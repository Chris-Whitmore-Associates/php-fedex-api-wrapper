 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FedExLocationType|string $LocationType
...
class HoldAtLocationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FedExLocationType|string $locationType
     * @return $this
     */
