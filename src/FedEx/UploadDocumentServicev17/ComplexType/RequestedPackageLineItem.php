 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\WeightSource|string $WeightSource
 * @property Dimensions $Dimensions
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PhysicalPackagingType|string $PhysicalPackaging
...
class RequestedPackageLineItem extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\WeightSource|string $weightSource
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PhysicalPackagingType|string $physicalPackaging
     * @return $this
     */
