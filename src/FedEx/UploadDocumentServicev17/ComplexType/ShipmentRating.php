 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $ActualRateType
...
class ShipmentRating extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $actualRateType
     * @return $this
     */
