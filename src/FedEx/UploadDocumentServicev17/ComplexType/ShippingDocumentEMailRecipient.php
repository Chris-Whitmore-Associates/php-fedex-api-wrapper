 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\EMailNotificationRecipientType|string $RecipientType
...
class ShippingDocumentEMailRecipient extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\EMailNotificationRecipientType|string $recipientType
     * @return $this
     */
