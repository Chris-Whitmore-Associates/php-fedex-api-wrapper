 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousContainerPackingType|string $PackingType
 * @property string $ContainerType
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RadioactiveContainerClassType|string $RadioactiveContainerClass
...
class DangerousGoodsContainer extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousContainerPackingType|string $packingType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RadioactiveContainerClassType|string $radioactiveContainerClass
     * @return $this
     */
