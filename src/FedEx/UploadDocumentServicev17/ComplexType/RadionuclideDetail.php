 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PhysicalFormType|string $PhysicalForm
...
class RadionuclideDetail extends AbstractComplexType
{
     ...
     * Set PhysicalForm
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PhysicalFormType|string $physicalForm
     * @return $this
     */
