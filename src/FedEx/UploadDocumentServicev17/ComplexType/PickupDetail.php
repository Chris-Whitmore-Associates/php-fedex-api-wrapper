 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PickupRequestType|string $RequestType
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PickupRequestSourceType|string $RequestSource
...
class PickupDetail extends AbstractComplexType
{
     ...
     * Set RequestType
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PickupRequestType|string $requestType
     * @return $this
     */
     ...
     * Set RequestSource
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PickupRequestSourceType|string $requestSource
     * @return $this
     */
