 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightGuaranteeType|string $Type
...
class FreightGuaranteeDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightGuaranteeType|string $type
     * @return $this
     */
