 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BarcodeSymbologyType|string $BarcodeSymbology
...
class CustomLabelBarcodeEntry extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BarcodeSymbologyType|string $barcodeSymbology
     * @return $this
     */
