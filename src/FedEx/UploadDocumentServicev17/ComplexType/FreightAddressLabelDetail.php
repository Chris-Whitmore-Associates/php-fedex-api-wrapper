 ...
 * @property int $Copies
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PageQuadrantType|string $StartingPosition
...
class FreightAddressLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PageQuadrantType|string $startingPosition
     * @return $this
     */
