 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentDispositionType|string $DispositionType
...
class ShippingDocumentDispositionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentDispositionType|string $dispositionType
     * @return $this
     */
