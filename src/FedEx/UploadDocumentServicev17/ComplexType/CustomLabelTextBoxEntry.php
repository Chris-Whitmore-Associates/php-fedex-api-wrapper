 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RotationType|string $Rotation
...
class CustomLabelTextBoxEntry extends AbstractComplexType
{
     ...
     * Set Rotation
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RotationType|string $rotation
     * @return $this
     */
