 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationSpecialServiceType|string[] $SpecialServiceTypes
...
class ConsolidationSpecialServicesRequested extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationSpecialServiceType[]|string[] $specialServiceTypes
     * @return $this
     */
