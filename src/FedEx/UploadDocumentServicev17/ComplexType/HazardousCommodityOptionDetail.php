 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityLabelTextOptionType|string $LabelTextOption
...
class HazardousCommodityOptionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityLabelTextOptionType|string $labelTextOption
     * @return $this
     */
