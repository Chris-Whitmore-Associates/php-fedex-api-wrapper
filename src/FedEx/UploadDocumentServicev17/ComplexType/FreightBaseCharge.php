 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightClassType|string $RatedAsClass
 * @property string $NmfcCode
 * @property string $Description
 * @property Weight $Weight
 * @property Money $ChargeRate
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightChargeBasisType|string $ChargeBasis
...
class FreightBaseCharge extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightClassType|string $ratedAsClass
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightChargeBasisType|string $chargeBasis
     * @return $this
     */
