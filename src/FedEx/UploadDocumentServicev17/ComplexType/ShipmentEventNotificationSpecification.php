 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShipmentNotificationRoleType|string $Role
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NotificationEventType|string[] $Events
...
class ShipmentEventNotificationSpecification extends AbstractComplexType
{
     ...
     * Set Role
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShipmentNotificationRoleType|string $role
     * @return $this
     */
     ...
     * Set Events
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NotificationEventType[]|string[] $events
     * @return $this
     */
