 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DestinationControlStatementType|string[] $StatementTypes
...
class DestinationControlDetail extends AbstractComplexType
{
     ...
     * Set StatementTypes
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DestinationControlStatementType[]|string[] $statementTypes
     * @return $this
     */
