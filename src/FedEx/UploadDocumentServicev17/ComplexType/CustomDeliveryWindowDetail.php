 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CustomDeliveryWindowType|string $Type
...
class CustomDeliveryWindowDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CustomDeliveryWindowType|string $type
     * @return $this
     */
