 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationType|string $Type
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationShipmentRoleType|string $Role
...
class CompletedShipmentConsolidationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ConsolidationShipmentRoleType|string $role
     * @return $this
     */
