 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightShipmentRoleType|string $PaymentType
...
class FreightSpecialServicePayment extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightShipmentRoleType|string $paymentType
     * @return $this
     */
