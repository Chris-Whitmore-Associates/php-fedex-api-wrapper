 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ClearanceBrokerageType|string $ClearanceBrokerage
 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\InternationalDocumentContentType|string $DocumentContent
 * @property Money $CustomsValue
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightOnValueType|string $FreightOnValue
 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RegulatoryControlType|string[] $RegulatoryControls
...
class CustomsClearanceDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ClearanceBrokerageType|string $clearanceBrokerage
     * @return $this
     */
     ...
     * Set DocumentContent
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\InternationalDocumentContentType|string $documentContent
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightOnValueType|string $freightOnValue
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RegulatoryControlType[]|string[] $regulatoryControls
     * @return $this
     */
