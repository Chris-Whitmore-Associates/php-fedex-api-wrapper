 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentStorageDetailType|string $Type
 * @property string $FilePath
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentNamingType|string $FileNaming
...
class ShippingDocumentStorageDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentStorageDetailType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentNamingType|string $fileNaming
     * @return $this
     */
