 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CommodityPurposeType|string $Purpose
...
class Commodity extends AbstractComplexType
{
     ...
     * Set Purpose
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CommodityPurposeType|string $purpose
     * @return $this
     */
