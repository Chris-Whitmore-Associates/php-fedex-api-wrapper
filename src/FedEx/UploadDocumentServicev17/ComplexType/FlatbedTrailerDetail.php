 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FlatbedTrailerOption|string[] $Options
...
class FlatbedTrailerDetail extends AbstractComplexType
{
     ...
     * Set Options
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FlatbedTrailerOption[]|string[] $options
     * @return $this
     */
