 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CustomerReferenceType|string $CustomerReferenceType
...
class CustomerReference extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CustomerReferenceType|string $customerReferenceType
     * @return $this
     */
