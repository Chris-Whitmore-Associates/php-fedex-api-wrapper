 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BinaryBarcodeType|string $Type
...
class BinaryBarcode extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BinaryBarcodeType|string $type
     * @return $this
     */
