 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DayOfWeekType|string $DeliveryDay
 * @property string $PublishedDeliveryTime
 * @property string $CommitDate
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DayOfWeekType|string $CommitDay
 * @property \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $TransitTime
 * @property \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $MaximumTransitTime
 * @property \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $CustomTransitTime
 * @property boolean $IneligibleForMoneyBackGuarantee
 * @property \FedEx\UploadDocumentServicev17\SimpleType\GroundDeliveryEligibilityType|string[] $DeliveryEligibilities
...
class ShipmentOperationalDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DayOfWeekType|string $deliveryDay
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DayOfWeekType|string $commitDay
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $transitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $maximumTransitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\TransitTimeType|string $customTransitTime
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\GroundDeliveryEligibilityType[]|string[] $deliveryEligibilities
     * @return $this
     */
