 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NaftaImporterSpecificationType|string $ImporterSpecification
 * @property Contact $SignatureContact
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NaftaProducerSpecificationType|string $ProducerSpecification
...
class NaftaCertificateOfOriginDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NaftaImporterSpecificationType|string $importerSpecification
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NaftaProducerSpecificationType|string $producerSpecification
     * @return $this
     */
