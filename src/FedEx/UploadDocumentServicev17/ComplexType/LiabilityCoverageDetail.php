 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\LiabilityCoverageType|string $CoverageType
...
class LiabilityCoverageDetail extends AbstractComplexType
{
     ...
     * Set CoverageType
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\LiabilityCoverageType|string $coverageType
     * @return $this
     */
