 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CustomsOptionType|string $Type
...
class CustomsOptionDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CustomsOptionType|string $type
     * @return $this
     */
