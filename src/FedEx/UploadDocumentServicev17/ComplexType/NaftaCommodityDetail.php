 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NaftaPreferenceCriterionCode|string $PreferenceCriterion
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NaftaProducerDeterminationCode|string $ProducerDetermination
 * @property string $ProducerId
 * @property \FedEx\UploadDocumentServicev17\SimpleType\NaftaNetCostMethodCode|string $NetCostMethod
...
class NaftaCommodityDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NaftaPreferenceCriterionCode|string $preferenceCriterion
     * @return $this
     */
     ...
     * Defined by NAFTA regulations.
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NaftaProducerDeterminationCode|string $producerDetermination
     * @return $this
     */
     ...
     * Set NetCostMethod
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\NaftaNetCostMethodCode|string $netCostMethod
     * @return $this
     */
