 ...
 *
 * @property string $Id
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightClassType|string $FreightClass
 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PhysicalPackagingType|string $Packaging
 * @property int $Pieces
 * @property string $NmfcCode
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityOptionType|string $HazardousMaterials
...
class FreightShipmentLineItem extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightClassType|string $freightClass
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PhysicalPackagingType|string $packaging
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityOptionType|string $hazardousMaterials
     * @return $this
     */
