 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\AssociatedShipmentType|string $Type
...
class AssociatedShipmentDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\AssociatedShipmentType|string $type
     * @return $this
     */
