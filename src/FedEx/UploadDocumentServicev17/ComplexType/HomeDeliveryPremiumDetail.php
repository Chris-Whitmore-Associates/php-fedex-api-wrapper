 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HomeDeliveryPremiumType|string $HomeDeliveryPremiumType
...
class HomeDeliveryPremiumDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HomeDeliveryPremiumType|string $homeDeliveryPremiumType
     * @return $this
     */
