 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\SplitPaymentType|string $Type
...
class SplitPaymentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\SplitPaymentType|string $type
     * @return $this
     */
