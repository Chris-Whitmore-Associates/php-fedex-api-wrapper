 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnedShippingDocumentType|string $Type
 * @property Localization[] $Localizations
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentGroupingType|string $Grouping
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentDispositionType|string $ShippingDocumentDisposition
...
class ShippingDocument extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnedShippingDocumentType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentGroupingType|string $grouping
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentDispositionType|string $shippingDocumentDisposition
     * @return $this
     */
