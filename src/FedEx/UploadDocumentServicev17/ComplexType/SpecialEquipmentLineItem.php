 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\SpecialEquipmentType|string $Type
...
class SpecialEquipmentLineItem extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\SpecialEquipmentType|string $type
     * @return $this
     */
