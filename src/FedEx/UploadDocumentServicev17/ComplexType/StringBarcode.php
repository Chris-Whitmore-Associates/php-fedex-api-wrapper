 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\StringBarcodeType|string $Type
...
class StringBarcode extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\StringBarcodeType|string $type
     * @return $this
     */
