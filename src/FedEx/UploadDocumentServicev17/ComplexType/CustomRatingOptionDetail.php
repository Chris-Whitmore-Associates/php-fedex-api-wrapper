 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CustomRatingOptionType|string[] $Options
...
class CustomRatingOptionDetail extends AbstractComplexType
{
     ...
     * Set Options
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CustomRatingOptionType[]|string[] $options
     * @return $this
     */
