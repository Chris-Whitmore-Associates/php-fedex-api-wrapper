 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DocTabContentType|string $DocTabContentType
...
class DocTabContent extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DocTabContentType|string $docTabContentType
     * @return $this
     */
