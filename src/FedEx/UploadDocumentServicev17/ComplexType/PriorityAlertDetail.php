 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PriorityAlertEnhancementType|string[] $EnhancementTypes
...
class PriorityAlertDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PriorityAlertEnhancementType[]|string[] $enhancementTypes
     * @return $this
     */
