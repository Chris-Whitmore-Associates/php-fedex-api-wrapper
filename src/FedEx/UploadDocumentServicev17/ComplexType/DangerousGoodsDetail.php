 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityRegulationType|string $Regulation
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsAccessibilityType|string $Accessibility
 * @property boolean $CargoAircraftOnly
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsDescriptorType|string[] $DangerousGoodsDescriptors
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityOptionType|string[] $Options
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsPackingOptionType|string $PackingOption
...
class DangerousGoodsDetail extends AbstractComplexType
{
     ...
     * Set Regulation
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityRegulationType|string $regulation
     * @return $this
     */
     ...
     * Set Accessibility
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsAccessibilityType|string $accessibility
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsDescriptorType[]|string[] $dangerousGoodsDescriptors
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityOptionType[]|string[] $options
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsPackingOptionType|string $packingOption
     * @return $this
     */
