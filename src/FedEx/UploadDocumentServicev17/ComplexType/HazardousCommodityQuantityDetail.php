 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityQuantityType|string $QuantityType
...
class HazardousCommodityQuantityDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\HazardousCommodityQuantityType|string $quantityType
     * @return $this
     */
