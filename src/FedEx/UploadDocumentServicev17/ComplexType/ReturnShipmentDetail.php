 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnType|string $ReturnType
 * @property Rma $Rma
...
class ReturnShipmentDetail extends AbstractComplexType
{
     ...
     * Set ReturnType
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnType|string $returnType
     * @return $this
     */
