 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BarcodeSymbologyType|string $Symbology
...
class DocTabContentBarcoded extends AbstractComplexType
{
     ...
     * Set Symbology
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BarcodeSymbologyType|string $symbology
     * @return $this
     */
