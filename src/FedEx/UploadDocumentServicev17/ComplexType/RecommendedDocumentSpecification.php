 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RecommendedDocumentType|string[] $Types
...
class RecommendedDocumentSpecification extends AbstractComplexType
{
     ...
     * Set Types
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RecommendedDocumentType[]|string[] $types
     * @return $this
     */
