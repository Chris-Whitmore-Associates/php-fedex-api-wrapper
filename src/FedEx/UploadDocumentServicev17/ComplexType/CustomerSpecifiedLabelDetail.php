 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RelativeVerticalPositionType|string $CustomContentPosition
 * @property CustomLabelDetail $CustomContent
 * @property ConfigurableLabelReferenceEntry[] $ConfigurableReferenceEntries
 * @property \FedEx\UploadDocumentServicev17\SimpleType\LabelMaskableDataType|string[] $MaskedData
 * @property \FedEx\UploadDocumentServicev17\SimpleType\SecondaryBarcodeType|string $SecondaryBarcode
...
class CustomerSpecifiedLabelDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RelativeVerticalPositionType|string $customContentPosition
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\LabelMaskableDataType[]|string[] $maskedData
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\SecondaryBarcodeType|string $secondaryBarcode
     * @return $this
     */
