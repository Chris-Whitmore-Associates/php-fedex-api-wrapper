 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CodCollectionType|string $CollectionType
 * @property Party $CodRecipient
 * @property ContactAndAddress $FinancialInstitutionContactAndAddress
 * @property string $RemitToName
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CodReturnReferenceIndicatorType|string $ReferenceIndicator
...
class CodDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CodCollectionType|string $collectionType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CodReturnReferenceIndicatorType|string $referenceIndicator
     * @return $this
     */
