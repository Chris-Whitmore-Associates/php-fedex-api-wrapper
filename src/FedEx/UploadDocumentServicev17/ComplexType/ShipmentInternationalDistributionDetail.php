 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DistributionClearanceType|string $ClearanceType
...
class ShipmentInternationalDistributionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DistributionClearanceType|string $clearanceType
     * @return $this
     */
