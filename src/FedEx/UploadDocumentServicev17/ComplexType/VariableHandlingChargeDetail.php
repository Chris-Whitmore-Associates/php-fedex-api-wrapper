 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RateElementBasisType|string $RateElementBasis
...
class VariableHandlingChargeDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RateElementBasisType|string $rateElementBasis
     * @return $this
     */
