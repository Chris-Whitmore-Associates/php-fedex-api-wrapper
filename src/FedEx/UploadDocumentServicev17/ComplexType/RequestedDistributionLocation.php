 ...
 *
 * @property string $Id
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FedExDistributionLocationType|string $Type
...
class RequestedDistributionLocation extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FedExDistributionLocationType|string $type
     * @return $this
     */
