 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\AdditionalLabelsType|string $Type
 * @property int $Count
...
class AdditionalLabelsDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\AdditionalLabelsType|string $type
     * @return $this
     */
