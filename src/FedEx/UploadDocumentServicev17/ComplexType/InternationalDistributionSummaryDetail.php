 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsAccessibilityType|string $DangerousGoodsAccessibility
...
class InternationalDistributionSummaryDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DangerousGoodsAccessibilityType|string $dangerousGoodsAccessibility
     * @return $this
     */
