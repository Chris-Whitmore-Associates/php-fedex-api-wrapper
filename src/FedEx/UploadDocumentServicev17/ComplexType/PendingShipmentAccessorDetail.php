 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\AccessorRoleType|string $Role
...
class PendingShipmentAccessorDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\AccessorRoleType|string $role
     * @return $this
     */
