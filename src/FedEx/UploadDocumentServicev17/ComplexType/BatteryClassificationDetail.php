 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BatteryMaterialType|string $Material
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BatteryPackingType|string $Packing
 * @property \FedEx\UploadDocumentServicev17\SimpleType\BatteryRegulatorySubType|string $RegulatorySubType
...
class BatteryClassificationDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BatteryMaterialType|string $material
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BatteryPackingType|string $packing
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\BatteryRegulatorySubType|string $regulatorySubType
     * @return $this
     */
