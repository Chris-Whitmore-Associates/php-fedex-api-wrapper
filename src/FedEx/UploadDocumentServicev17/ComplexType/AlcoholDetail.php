 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\AlcoholRecipientType|string $RecipientType
...
class AlcoholDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\AlcoholRecipientType|string $recipientType
     * @return $this
     */
