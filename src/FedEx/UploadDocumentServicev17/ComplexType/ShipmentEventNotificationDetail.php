 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShipmentNotificationAggregationType|string $AggregationType
...
class ShipmentEventNotificationDetail extends AbstractComplexType
{
     ...
     * Set AggregationType
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShipmentNotificationAggregationType|string $aggregationType
     * @return $this
     */
