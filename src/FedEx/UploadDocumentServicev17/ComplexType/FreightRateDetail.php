 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightRateQuoteType|string $QuoteType
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightBaseChargeCalculationType|string $BaseChargeCalculation
...
class FreightRateDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightRateQuoteType|string $quoteType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightBaseChargeCalculationType|string $baseChargeCalculation
     * @return $this
     */
