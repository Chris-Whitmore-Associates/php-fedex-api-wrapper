 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShipmentProcessingOptionType|string[] $Options
...
class ShipmentProcessingOptionsRequested extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShipmentProcessingOptionType[]|string[] $options
     * @return $this
     */
