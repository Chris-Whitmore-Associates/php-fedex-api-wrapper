 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\TransborderDistributionSpecialServiceType|string[] $SpecialServiceTypes
...
class TransborderDistributionSpecialServicesRequested extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\TransborderDistributionSpecialServiceType[]|string[] $specialServiceTypes
     * @return $this
     */
