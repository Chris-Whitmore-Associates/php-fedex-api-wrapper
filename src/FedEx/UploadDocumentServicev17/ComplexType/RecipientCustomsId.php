 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RecipientCustomsIdType|string $Type
...
class RecipientCustomsId extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RecipientCustomsIdType|string $type
     * @return $this
     */
