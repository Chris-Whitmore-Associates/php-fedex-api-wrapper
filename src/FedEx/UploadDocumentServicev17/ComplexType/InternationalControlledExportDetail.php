 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\InternationalControlledExportType|string $Type
...
class InternationalControlledExportDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\InternationalControlledExportType|string $type
     * @return $this
     */
