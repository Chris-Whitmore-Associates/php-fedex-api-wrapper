 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CarrierCodeType|string $PickUpCarrier
...
class CompletedSmartPostDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CarrierCodeType|string $pickUpCarrier
     * @return $this
     */
