 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\EtdConfirmationType|string $Confirmation
 * @property \FedEx\UploadDocumentServicev17\SimpleType\EtdAttributeType|string[] $Attributes
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RequestedShippingDocumentType|string[] $RequestedDocumentCopies
...
class EtdDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\EtdConfirmationType|string $confirmation
     * @return $this
     */
     ...
     * Set Attributes
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\EtdAttributeType[]|string[] $attributes
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RequestedShippingDocumentType[]|string[] $requestedDocumentCopies
     * @return $this
     */
