 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\WeighingScaleType|string $Type
...
class WeighingDetail extends AbstractComplexType
{
     ...
     * Type of scale used
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\WeighingScaleType|string $type
     * @return $this
     */
