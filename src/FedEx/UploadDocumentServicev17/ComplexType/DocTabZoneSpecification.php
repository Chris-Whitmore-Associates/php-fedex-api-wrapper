 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DocTabZoneJustificationType|string $Justification
...
class DocTabZoneSpecification extends AbstractComplexType
{
     ...
     * Set Justification
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DocTabZoneJustificationType|string $justification
     * @return $this
     */
