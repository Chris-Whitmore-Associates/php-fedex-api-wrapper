 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DocumentUsageType|string $Usage
...
class UploadDocumentsRequest extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DocumentUsageType|string $usage
     * @return $this
     */
