 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\DropoffType|string $DropoffType
 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ErrorLabelBehaviorType|string $ErrorLabelBehavior
 * @property LabelSpecification $LabelSpecification
 * @property ShippingDocumentSpecification $ShippingDocumentSpecification
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RateRequestType|string[] $RateRequestTypes
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $CustomerSelectedActualRateType
 * @property \FedEx\UploadDocumentServicev17\SimpleType\EdtRequestType|string $EdtRequestType
 * @property CustomRatingOptionDetail $CustomRatingOptionDetail
 * @property TrackingId $MasterTrackingId
 * @property int $PackageCount
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShipmentOnlyFieldsType|string[] $ShipmentOnlyFields
...
class RequestedShipment extends AbstractComplexType
{
     ...
     * Set DropoffType
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\DropoffType|string $dropoffType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ErrorLabelBehaviorType|string $errorLabelBehavior
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RateRequestType[]|string[] $rateRequestTypes
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $customerSelectedActualRateType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\EdtRequestType|string $edtRequestType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShipmentOnlyFieldsType[]|string[] $shipmentOnlyFields
     * @return $this
     */
