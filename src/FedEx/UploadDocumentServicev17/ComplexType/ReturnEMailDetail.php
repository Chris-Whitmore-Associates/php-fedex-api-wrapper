 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnEMailAllowedSpecialServiceType|string[] $AllowedSpecialServices
...
class ReturnEMailDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnEMailAllowedSpecialServiceType[]|string[] $allowedSpecialServices
     * @return $this
     */
