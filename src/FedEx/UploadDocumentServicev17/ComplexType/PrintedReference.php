 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PrintedReferenceType|string $Type
...
class PrintedReference extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PrintedReferenceType|string $type
     * @return $this
     */
