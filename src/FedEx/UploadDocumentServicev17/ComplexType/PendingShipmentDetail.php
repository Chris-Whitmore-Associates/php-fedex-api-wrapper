 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PendingShipmentType|string $Type
...
class PendingShipmentDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PendingShipmentType|string $type
     * @return $this
     */
