 ...
 *
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CustomsRoleType|string $Role
...
class NaftaLowValueStatementDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CustomsRoleType|string $role
     * @return $this
     */
