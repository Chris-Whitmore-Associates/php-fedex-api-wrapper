 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $RateType
 * @property string $RateScale
 * @property string $RateZone
 * @property \FedEx\UploadDocumentServicev17\SimpleType\PricingCodeType|string $PricingCode
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RatedWeightMethod|string $RatedWeightMethod
 * @property \FedEx\UploadDocumentServicev17\SimpleType\MinimumChargeType|string $MinimumChargeType
 * @property CurrencyExchangeRate $CurrencyExchangeRate
 * @property \FedEx\UploadDocumentServicev17\SimpleType\SpecialRatingAppliedType|string[] $SpecialRatingApplied
 * @property int $DimDivisor
 * @property \FedEx\UploadDocumentServicev17\SimpleType\RateDimensionalDivisorType|string $DimDivisorType
...
class ShipmentLegRateDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ReturnedRateType|string $rateType
     * @return $this
     */
     ...
     * Set PricingCode
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\PricingCodeType|string $pricingCode
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RatedWeightMethod|string $ratedWeightMethod
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\MinimumChargeType|string $minimumChargeType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\SpecialRatingAppliedType[]|string[] $specialRatingApplied
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\RateDimensionalDivisorType|string $dimDivisorType
     * @return $this
     */
