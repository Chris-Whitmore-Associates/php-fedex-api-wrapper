 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CreditCardAuthorizationType|string $AuthorizationType
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CreditCardSettlementScheduleType|string $SettlementScheduleType
...
class CreditCardTransactionDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CreditCardAuthorizationType|string $authorizationType
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CreditCardSettlementScheduleType|string $settlementScheduleType
     * @return $this
     */
