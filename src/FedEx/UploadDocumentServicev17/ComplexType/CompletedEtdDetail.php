 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\CompletedEtdType|string $Type
...
class CompletedEtdDetail extends AbstractComplexType
{
     ...
     * Set Type
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\CompletedEtdType|string $type
     * @return $this
     */
