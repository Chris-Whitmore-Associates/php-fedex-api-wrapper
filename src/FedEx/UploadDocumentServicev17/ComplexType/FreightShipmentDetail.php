 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightShipmentRoleType|string $Role
 * @property \FedEx\UploadDocumentServicev17\SimpleType\FreightCollectTermsType|string $CollectTermsType
...
class FreightShipmentDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightShipmentRoleType|string $role
     * @return $this
     */
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\FreightCollectTermsType|string $collectTermsType
     * @return $this
     */
