 ...
 * @property \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentEMailGroupingType|string $Grouping
...
class ShippingDocumentEMailDetail extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\UploadDocumentServicev17\SimpleType\ShippingDocumentEMailGroupingType|string $grouping
     * @return $this
     */
